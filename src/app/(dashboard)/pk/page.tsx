...
import { Award, Loader2, Swords, Trophy, Users } from 'lucide-react'
          ...
          <CardHeader className="text-center">
            {isWinner && (
              <motion.div
                ...
                className="bg-primary absolute -top-6 left-1/2 -translate-x-1/2 rounded-full p-3 shadow-lg"
              >
              ...
              {isStudent ? (
                participant.student?.avatar ? (
                  <img
                    ...
                    className={`h-24 w-24 rounded-full object-cover ring-4 ring-offset-4 ${isWinner ? 'ring-primary' : 'ring-transparent'}`}
                  />
                ) : (
                  <div
                    className={`bg-muted flex h-24 w-24 items-center justify-center rounded-full text-3xl font-bold ring-4 ring-offset-4 ${isWinner ? 'ring-primary' : 'ring-transparent'}`}
                  >
                ...
                <div
                  className={`flex h-24 w-24 items-center justify-center rounded-full text-3xl font-bold ring-4 ring-offset-4 ${isWinner ? 'ring-primary' : 'ring-transparent'}`}
                  style={{
          ...
          <div className="grid gap-6 md:grid-cols-3">
            ...
            <div className="flex items-center justify-center">
              <motion.div
                ...
                className="flex h-24 w-24 items-center justify-center rounded-full bg-gradient-to-br from-red-500 to-blue-500 shadow-xl"
              >
